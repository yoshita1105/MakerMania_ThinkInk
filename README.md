...
* Laser X – Home laser tag system with guns and chest receivers.
* Nerf Laser Ops Pro – Laser blasters with app connectivity.
* Battle Company – Professional laser tag arena equipment.
* Traditional indoor laser tag systems used in entertainment centers.
* Paintball and airsoft games (alternative combat simulation games).
